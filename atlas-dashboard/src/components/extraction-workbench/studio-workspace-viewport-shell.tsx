...
} from "./studio-workspace-viewport-props";

import { StudioWorkspaceCanvasSection } from "./studio-workspace-canvas-section";

export type { WorkspaceViewportShellProps } from "./studio-workspace-viewport-props";

export function StudioWorkspaceViewportShell({
